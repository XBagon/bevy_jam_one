use crate::{
    nalgebra::Vector2, util, util::DespawnEntity, Player, PlayerDamaged, HALF_HEIGHT, PHYSICS_SCALE,
};
...
impl SpawnSlimeBall {
    pub fn handle_event(
        ...
        for _ in ev_spawn_slime_ball.iter() {
            commands
                .spawn_bundle(slime_ball_bundle.clone())
