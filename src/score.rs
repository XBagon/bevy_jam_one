use bevy::prelude::*;
use crate::{game, HALF_HEIGHT, HALF_WIDTH, PlayerDamaged};
...
impl Score {
    ...
    pub fn on_player_damaged(mut ev_player_damaged: EventReader<PlayerDamaged>, mut q_score: Query<(&mut Score, &mut Text)>) {
    ...
    pub fn on_end(mut q_score: Query<(&Score, &mut Transform, &mut Text)>, mut ev_phase: EventReader<game::Phase>) {
